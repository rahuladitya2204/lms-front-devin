...
function PastLiveTests(props:{filter:Types.GetLiveTestssFilter}) {
  const { data, isLoading: loading } = User.Queries.useGetLiveTests(props.filter);
  return (
      <Card
        bodyStyle={{ padding: 0 }}
      >
