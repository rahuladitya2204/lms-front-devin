      ...
      items={[
        {
          ...
          children: (
            <Form
              ...
              onFinish={(e) => {
                // debugger;
                const temp = TEST_TEMPLATES.find(
                  (t) => t.value === e.template
                )?.template;
                // @ts-ignore
                onSubmit(temp);
              }}
                              ...
                              >
                                <Select
                                  options={[
                                    {
                                      label: "Single Choice",
                                      value: Enum.TestQuestionType.SINGLE,
                                    },
                                    {
                                      label: "Multiple Choice",
                                      value: Enum.TestQuestionType.MULTIPLE,
                                    },
                                    {
                                      label: "Numeric",
                                      value: Enum.TestQuestionType.NUMERIC,
                                    },
                                    {
                                      label: "Subjective",
                                      value: Enum.TestQuestionType.SUBJECTIVE,
                                    },
                                  ]}
                                />
                              </Form.Item>
