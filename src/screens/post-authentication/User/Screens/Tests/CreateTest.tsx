...
const CreateTest: React.FC<CreateTestComponentPropsI> = (props) => {
  ...
  const { mutate: createTest, isLoading: createTestLoading } =
    User.Queries.useCreateTest();
  const { mutate: updateTest, isLoading: updateTestLoading } =
            ...
            <>
              <Form form={form} onFinish={onSubmit} layout="vertical">
                  ...
                  <Col span={16}>
                    <Form.Item
                      rules={[
                        {
                          required: true,
                          message: "Please enter a title of the tests",
                        },
                      ]}
                      name="title"
                      label="Test Title"
                ...
                <Row gutter={[20, 20]}>
                  ...
                  <Col span={12}>
                    {" "}
                    <PriceFormItem name="price" label="Price" />
                  </Col>
                </Row>
              </Form>
            </>
                ...
                <Fragment>
                  <Col span={24}>
                    <Card
                      ...
                      extra={
                        <ActionModal
                          cta={<Button type="primary">Add Outcome</Button>}
                        >
                          <AddOutcome
                            submit={(e: Outcome) => {
                              console.log(e, "e");
