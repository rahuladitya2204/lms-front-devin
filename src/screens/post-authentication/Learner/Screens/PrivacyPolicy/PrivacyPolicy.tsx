        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1>Privacy Policy for Nimble Bee</h1>
              <p>
                At https://{alias}.nimblebee.io, accessible from https://{alias}.nimblebee.io,
                one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is
                collected and recorded by https://{alias}.nimblebee.io and how
                we use it.
              </p>
              <p>
              ...
              <p>
                ...
                information that they shared and/or collect in https://{alias}.nimblebee.io.
              ...
              <h2>Log Files</h2>
              <p>
                https://{alias}.nimblebee.io follows a standard procedure of
              ...
              <p>
                ...
                the advertising partners of https://{alias}.nimblebee.io.
              </p>
              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on https://{
                  alias
                }.nimblebee.io, which are sent directly to users' browser. They
              ...
              <p>
                Note that https://{alias}.nimblebee.io has no access to or
                control over these cookies that are used by third-party
                advertisers.
              </p>
              <h2>Third Party Privacy Policies</h2>
              <p>
                https://{alias}.nimblebee.io's Privacy Policy does not apply to
              ...
              <p>
                https://{alias}.nimblebee.io does not knowingly collect any
