...
const EventCard = (props: { eventId: string }) => {
  ...
  // console.log(event, 'event');
  const plan =
    (event.plan as unknown as Types.Plan) ||
      ...
      <Row gutter={[20, 40]} align="stretch">
        ...
        <Col span={24} flex={1}>
          <Row gutter={[20, 10]}>
            ...
            {!event.startedAt ? (
              <Col span={24}>
                <Tag color="blue">
                  Starting in <Countdown targetDate={event.scheduledAt} />{" "}
                </Tag>
              </Col>
            ) : (
              <Col span={24}>
        ...
        {isEnrolled ? (
          event.startedAt ? (
            ...
            <Title level={4}>You have already enrolled for this session</Title>
          )
        ) : (
          <Col span={24}>
            <Row gutter={[10, 10]}>
