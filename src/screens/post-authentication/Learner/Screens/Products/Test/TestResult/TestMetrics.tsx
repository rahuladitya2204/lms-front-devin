              ...
              <Row gutter={[20, 20]}>
                  ...
                  {loadingResult ? (
                    ...
                    <Card style={{ marginBottom: 20, textAlign: "center" }}>
                      ...
                      <Title
                        ...
                        level={4}
                      >
                        {FormatLangText('YOU_SCORED')}: {Math.ceil(metrics.learnerScore)} out of{" "}
                  ...
                  >
                    ...
                    {enrolledProduct.metadata.test.startedAt ||
                      ...
                      <Col xs={24} sm={8}>
                        <Card bordered={false}>
                          <Statistic
                            title={FormatLangText('TIME_TAKEN')}
                ...
                <Col xs={24} md={12} lg={16}>
                  {loadingResult ? (
                    ...
                    <Row gutter={[20, 20]}>
                      <Col span={24}>
                        <Card title={FormatLangText('TEST_ANALYSIS_REPORT')}>
                          <Title level={3}>
                            {FormatLangText('SECTION_WISE_BREAKDOWN')}
                          </Title>
                              ...
                              <Row key={section.title}>
                                ...
                                <Col sm={24}>
                                  <Row gutter={[20, 20]}>
                                    ...
                                    <Col span={12}>
                                      {FormatLangText('CORRECTLY_ANSWERED')}{" "}
                                      {
                                        section?.stats
                        ...
                        <Col span={24}>
                          <Spin spinning={loadingTopicTree}>
                            <Card
                              ...
                              title={FormatLangText('TOPIC_WISE_REPORT')}
                              extra={
