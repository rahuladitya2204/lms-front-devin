...
export default function TicketDetail() {
  ...
  const {
    data: ticket,
    isFetching: loadingTicket,
    isLoading: loadingTicketFirst,
  } = Learner.Queries.useGetTicketDetails(id + "");
  ...
  const { mutate: replyToTicket, isLoading: postingReply } =
    Learner.Queries.useReplyToTicket();
                ...
                <>
                  <Spin spinning={loadingTicket}>
                    <List
                      ...
                      // @ts-ignore
                      dataSource={ticket.replies.sort(
                        (a, b) => b.date - a.date
                      )}
                      renderItem={(item) => {
